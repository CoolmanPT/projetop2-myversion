...
public class AreaJogavel implements Iteravel, InterativoPosicao {
    ...
    private static final int PEDRA__ = 9;
    private static final int MEGA__ = 8;
...
//    GRANDE
    private static final int[][] NIVEL = {
            {MEGA__, BASESUP, BASESUP, BASEAR_, BASESUP, BASESUP, BASESUP, BASESUP, BASESUP},
            ...
            {BASESUP, BASEAR_, BASEAR_, BASESUP, BASESUP, PEDRA__, BASESUP, BASESUP, BASESUP},
            ...
            {BASESUP, BASESUP, BASEAR_, BASESUP, BASESUP, BASESUP, PEDRA__, BASESUP, BASESUP},
            ...
            for (int j = 0; j < NUMERO_COLUNAS; j++) {
                ...
                switch (NIVEL[i][j]) {
                    ...
                    case PEDRA__:
                        ...
                        break;
                    case MEGA__:
                        criarMega((BaseSuportadora) grelha[i][j]);
                        break;
                }
            }
    }
    ...
    private void criarMega(BaseSuportadora baseSuportadora) {
    MegaBomb megaBomb = new MegaBomb(baseSuportadora);
    baseSuportadora.setSuportado(megaBomb);
        if (jogo != null) {
           jogo.informarCriacaoMegabomb(megaBomb, baseSuportadora);
        }
    }
    ...
    public List<BaseSuportadora> getAllThings(){
        List<BaseSuportadora> bases = new ArrayList<>();
