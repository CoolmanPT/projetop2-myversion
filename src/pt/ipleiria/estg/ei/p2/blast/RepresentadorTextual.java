...
public class RepresentadorTextual implements OuvinteJogo {
        ...
        if (base instanceof BaseAr) {
            ...
            if (baseSuportadora.isVazia())
                ...
                if (suportado instanceof Porco) {
                    ...
                    Pedra pedra = (Pedra) baseSuportadora.getSuportado();
                    if (pedra.getForca() > 2)
                    texto +="K";
                    else
                        texto += "k";
                }
                else if(suportado instanceof MegaBomb){
                    texto += "Q";
                }
    ...
    @Override
    public void megaBombCriada(MegaBomb megaBomb, BaseSuportadora baseSuportadora) {
        System.out.println("Foi criado uma megabomb em " + getRepresentacaoPosicao(baseSuportadora.getPosicao()));
    }
